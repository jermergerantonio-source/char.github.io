/**
 * SISTEMA DE CLASIFICACION AUTOMATICA DE OBJETOS
 * Clasificador ambiental basado en huella hidrica y necesidad
 * 
 * Objetivo: Evaluar objetos por su impacto ambiental y necesidad
 * para proporcionar educacion sobre consumo responsable
 ...
 * 2 = Util (funcional pero reemplazable o cambiable)
...
// 2. CONFIGURACION DE REGLAS DE CLASIFICACION
// Come As You Are

/**
 * Tabla de decision que combina:
 * - Impacto hidrico (bajo, medio, alto)
 * - Nivel de necesidad (no esencial, util, necesario)
 * 
...
/**
 * Equivalencias para hacer el mensaje mas educativo
...
// 3.1. ALTERNATIVAS ECOLoGICAS Y SUGERENCIAS DE CONSUMO
/**
...
function obtenerNecesidad(objeto) {
  return tblNecesidad[objeto] || 2; // Default: util
}

/**
 * Convierte numero de necesidad a texto legible
 * @param {number} nivel - Nivel de necesidad (1, 2 o 3)
 * @returns {string} - Descripcion legible
 */
...
/**
 * Encuentra la equivalencia mas cercana
...
/**
 * Clasifica un objeto segun impacto y necesidad
 * @param {string} objeto - Nombre del objeto
...
/**
 * Genera un mensaje explicativo segun la categoria
 * @param {object} datos - Objeto con informacion de clasificacion
...
// 6. FUNCION PRINCIPAL DE CLASIFICACION

/**
 * Clasifica automaticamente un objeto completo
 ...
 * @param {array} clasificaciones - Array de resultados de clasificacion
 * @returns {object} - Conteo por categoria
 */
